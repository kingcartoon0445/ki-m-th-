...
namespace EShopeeeeee.Controllers
{
    public class ProductTypesController : Controller
    {
        ...
        public ProductTypesController(EShopeeeeeeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Name,Stratus")] ProductTypes productTypes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,Stratus")] ProductTypes productTypes)
        {
