...
namespace EShopeeeeee.Controllers
{
    public class CartsController : Controller
    {
        ...
        public CartsController(EShopeeeeeeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id,Quantity")] Carts carts)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Quantity")] Carts carts)
        {
            if (id != carts.id)
            {
                return NotFound();
